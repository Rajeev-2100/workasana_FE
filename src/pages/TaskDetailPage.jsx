    ...
    <div className="d-flex min-vh-100" style={{ backgroundColor: "#f5f7fa" }}>
      ...
      >
        ...
        <ul className="nav flex-column px-3 gap-1">
          {[
            { icon: "bi-speedometer2", label: "Dashboard", to: "/dashboardPage" },
            { icon: "bi-folder", label: "Project", to: "/projects" },
            { icon: "bi-journal-check", label: "Task", to: "/tasks", active: true },
            { icon: "bi-people", label: "Team", to: "/team" },
            { icon: "bi-graph-up", label: "Reports", to: "/reports" },
            { icon: "bi-gear", label: "Setting", to: "/setting" },
          ].map((item) => (
            <li key={item.label} className="nav-item">
              <Link
                to={item.to}
                className={`nav-link py-2 px-3 rounded d-flex align-items-center gap-3 ${
                  item.active
                    ...
                    <div className="col-md-6">
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          setEditData({ ...editData, owners: selectedOptions });
                        }}
                        required
